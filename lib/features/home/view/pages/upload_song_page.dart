...
class _UploadSongPageState extends ConsumerState<UploadSongPage> {
 ...
 File? selectedImage;
  ...
  Widget build(BuildContext context) {
    ...
    body:
    isLoading ? const Loader() : SingleChildScrollView(
      child: Padding(
          ...
          child: Column(
                  ...
                  child:SizedBox(
                    ...
                    child:  Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 15,),
                        Text("Select the thumbail for your song",
           ...
           const SizedBox(height: 40,),
            selectedAudio != null ? AudioWave(path: selectedAudio!.path,)
                :   CustomField(hinText:"Pick Song"
                  , controller: null,
              readOnly: true,
                onTap:selectAudio
              ),
              const SizedBox(height: 20,),
              CustomField(hinText: "Artist", controller: songNameController),
              const SizedBox(height: 20,),
              CustomField(hinText: "Song Name", controller: artistNameController),
               ColorPicker(
